...
DataSet data = ReadDataFile("_codenames_Aligned_NPs_Equine.fasta");
assert(data.sites % 3 == 0, "Sequence lengths not multiples of 3");
totalcodons = data.sites $ 3;
fprintf(stdout, "Read from _codenames_Aligned_NPs_Equine.fasta a set of ", data.species, " sequences consisting of ", data.sites, " nucleotides corresponding to ", totalcodons, " codons each.\n");
...
fprintf(stdout, "Reading tree string from _codenames_codonphyml_Equine_tree.newick.\n");
fscanf("_codenames_codonphyml_Equine_tree.newick", String, treestring);
