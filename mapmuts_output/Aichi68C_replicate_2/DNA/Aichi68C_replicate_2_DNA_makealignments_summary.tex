...
\centerline{\includegraphics[width=4in]{Aichi68C_replicate_2_DNA_alignmentstatistics.pdf}}
\vspace{0.3in}

\centerline{\includegraphics[width=4in]{Aichi68C_replicate_2_DNA_insertlengths.pdf}}
\end{minipage}
...
\centerline{\includegraphics[width=3in]{Aichi68C_replicate_2_DNA_R1mismatches.pdf}\hspace{0.3in}\includegraphics[width=3in]{Aichi68C_replicate_2_DNA_R2mismatches.pdf}}
\end{document}
