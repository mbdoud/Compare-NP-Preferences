...
\centerline{\includegraphics[width=4in]{PR8_replicate_2_DNA_alignmentstatistics.pdf}}
\vspace{0.3in}

\centerline{\includegraphics[width=4in]{PR8_replicate_2_DNA_insertlengths.pdf}}
\end{minipage}
...
\centerline{\includegraphics[width=3in]{PR8_replicate_2_DNA_R1mismatches.pdf}\hspace{0.3in}\includegraphics[width=3in]{PR8_replicate_2_DNA_R2mismatches.pdf}}
\end{document}
