...
\centerline{\includegraphics[width=4in]{Aichi68C_replicate_1_virus_alignmentstatistics.pdf}}
\vspace{0.3in}

\centerline{\includegraphics[width=4in]{Aichi68C_replicate_1_virus_insertlengths.pdf}}
\end{minipage}
...
\centerline{\includegraphics[width=3in]{Aichi68C_replicate_1_virus_R1mismatches.pdf}\hspace{0.3in}\includegraphics[width=3in]{Aichi68C_replicate_1_virus_R2mismatches.pdf}}
\end{document}
